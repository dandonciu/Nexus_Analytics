...
if st.session_state.active_tab == "📊 Dashboard Executiv":
    ...
    if selected_category == "Toate categoriile":
        st.markdown("""
        <div style="color: #475569; background-color: #f1f5f9; border-left: 4px solid #94a3b8; padding: 6px 12px; border-radius: 6px; font-size: 12px; margin-bottom: 15px; font-family: sans-serif;">
